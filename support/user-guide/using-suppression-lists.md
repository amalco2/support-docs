...
* **Suppression list UI:** In the User Interface choose Recipients and the Suppressions.
...
To inspect the status of a recipient on your Suppression List, you can [Find by Email](https://app.sparkpost.com/lists/suppressions) ([EU)](https://app.eu.sparkpost.com/lists/suppressions))
